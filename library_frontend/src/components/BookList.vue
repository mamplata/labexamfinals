                    ...
                    <tr v-for="b in books" :key="b.id">
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <button class="btn btn-sm btn-danger rounded" @click="removeBook(b.id)">
                    ...
                    <div class="modal-body">
                        ...
                        <form @submit.prevent="saveBook">
                            ...
                            <div class="mb-3">
                                ...
                                <input v-model.number="form.copies_available" type="number" min="0" class="form-control"
                                    required @input="validateCopiesAvailable" />
